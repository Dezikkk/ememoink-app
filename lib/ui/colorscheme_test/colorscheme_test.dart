...
Color selectedColor = const Color(0xFF733FC7);
Brightness selectedBrightness = Brightness.light;
double selectedContrast = 0.0;

const List<DynamicSchemeVariant> schemeVariants = DynamicSchemeVariant.values;

class ColorSchemeTest extends StatefulWidget {
  const ColorSchemeTest({super.key});

  @override
  State<ColorSchemeTest> createState() => _ColorSchemeTestState();
}

class _ColorSchemeTestState extends State<ColorSchemeTest> {
...
enum ColorSeed {
  baseColor('M3 Baseline', Color(0xFF733FC7));
